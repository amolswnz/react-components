...
function SingleSelectPreview() {
  ...
  const [_createSingleQuery, setCreateSingleQuery] = useState('');
  ...
  return (
    <div className='space-y-5'>
      <div className='my-4'>
        ...
        <SingleSelect options={fruits} value={singleValue} onChange={setSingleValue} placeholder='Select a fruit...' />
      ...
      <div className='my-4'>
        ...
        <p className='mt-1 text-xs text-muted-foreground'>
          Uses &quot;https://jsonplaceholder.typicode.com/users?q=search&quot;, which searches through whole user data fields
        </p>
      </div>
      <div className='my-4'>
        <label className='mb-1.5 block text-sm font-medium'>
